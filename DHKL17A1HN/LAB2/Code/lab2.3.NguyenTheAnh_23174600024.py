...
try:
    ...
    file_path_efficiency = 'H:/17A1KHDL/LAB2/DATA/efficiency.txt'  # Thay bằng đường dẫn chính xác của bạn
    file_path_shifts = 'H:/17A1KHDL/LAB2/DATA/shifts.txt'  # Thay bằng đường dẫn chính xác của bạn
